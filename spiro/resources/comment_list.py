...
@handle_exception
def get_comment_list(article_uuid, primary_comment_offset, primary_comment_count, sub_comment_count):
  ...
  flag, comments, sub_comments = Comment.find_rangeof_comments_by_article_uuid(article_uuid, primary_comment_offset, primary_comment_count + 1, sub_comment_count + 1)
  if flag:
